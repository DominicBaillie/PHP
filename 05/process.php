...
$sql = "INSERT INTO orders (first_name, last_name, phone, address, email, chaos_croissant, midnight_muffin, existential_eclair, procrastination_cookie, finals_week_brownie, victory_cinnamon_roll, comments) VALUES (:first_name, :last_name, :phone, :address, :email, :chaos_croissant, :midnight_muffin, :existential_eclair, :procrastination_cookie, :finals_week_brownie, :victory_cinnamon_roll, :comments)";
...
$stmt->bindParam(':existential_eclair', $essentialEclair);
